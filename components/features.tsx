      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Gokarneshwor Run strives to:</h2>
            <p className="text-xl text-gray-400">
              Whether you are a seasoned jogger who wants to work toward a new
              goal, or a novice runner who is inspired by a friend's
              accomplishment of winning a race, there are many personal reasons
              as to why you would want to train for and run in a marathon
            </p>
          </div>
          ...
          <div
            ...
            <div
              ...
              {/* <h4 className="h4 mb-2">Instant Featuresss</h4> */}
              <p className="text-lg text-gray-400 text-center">
                Promote running for health and discourage smoking, drugs, and
                alcohol
              </p>
            </div>
            ...
            <div
              ...
              <p className="text-lg text-gray-400 text-center">
                Support and motivate all participants.
              </p>
            </div>
            ...
            <div
              ...
              {/* <h4 className="h4 mb-2">Instant Features</h4> */}
              <p className="text-lg text-gray-400 text-center">
                Develop running sports using local resources
              </p>
            </div>
            ...
            <div
              ...
              {/* <h4 className="h4 mb-2">Instant Features</h4> */}
              <p className="text-lg text-gray-400 text-center">
                Assist local players in national tournaments.
              </p>
            </div>
