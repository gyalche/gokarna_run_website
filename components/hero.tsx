'use client';
import VideoThumb from '@/public/images/thumnail.png';
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p
              ...
              data-aos="fade-up"
              data-aos-delay="200">
              Gokarneshwor Run Samuha, established by Mr.Tenji Sherpa on January
              06, 2024, is a non-profit organization hosting weekly running
              events inspired by the UK's Park Run and Dharan Run's Santosh Rai.
              Every Saturday at 7:00 am, the free timed run starts from Sahid
              Park Gate, covering a 3.7 km route over two rounds. Participants
              range from 4-year-old juniors to 70-year-old seniors, and there
              are no strict rules – you can run, jog, or walk, wearing whatever
              feels comfortable. The aim is to engage youth in a healthy
              lifestyle through running and social work. Participants completing
              20 or 50 weeks receive incentives like T-shirts, while
              underprivileged children regularly participating may get running
              shoes if available through donors.
            </p>
